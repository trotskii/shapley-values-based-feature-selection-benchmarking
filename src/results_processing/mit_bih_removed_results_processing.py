...
def main():
    ...
    for TEST_TRAIN in ['test', 'train']:
        ensure_dir_path('csv_results_outputs/metrics/mit_bih_removed/')
        ...
        df_metrics.to_csv(f'csv_results_outputs/metrics/mit_bih_removed/mit_bih_removed_performance_{TEST_TRAIN}.csv', sep=';')
